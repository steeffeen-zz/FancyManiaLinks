...
$mpIconQuad->setSubStyle($mpIconQuad::SUBSTYLE_ManiaPlanetLogoWhite);
...
$emblemQuad->setSubStyle($emblemQuad::SUBSTYLE_1);
...
$emblemQuad->setX(110);
$emblemQuad->setSize(70, 70);
$emblemQuad->setSubStyle($emblemQuad::SUBSTYLE_2);
...
$backgroundQuad->setSubStyle($backgroundQuad::SUBSTYLE_PlayerSlot);
